<nav class="menu-category">
    <!-- lien de la boutique normal -->
    <h4><a href=" <?php echo get_permalink('6') ?>"> Tout</a></h4>
    ...
    foreach ($product_cat as $parent_product_cat) { ?>
        ...
        <ul>
            <li class="category category-id-<?php echo $parent_product_cat->term_id ?>">
                <h4><a href=" <?php echo get_term_link($parent_product_cat->term_id) ?>"> <?php echo $parent_product_cat->name ?></a></h4>
                ...
                <ul>
                    ...
                    foreach ($child_product_cats as $child_product_cat) { ?>
                        ...
                        <li class="sub-category"><a href=" <?php echo get_term_link($child_product_cat->term_id) ?> "> <?php echo $child_product_cat->name ?> </a>
