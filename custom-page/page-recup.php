...
<main>
     ...
     <section class="reparation u-margin-top-big container-big">
          ...
          <button class="btn btn__dark u-margin-top-small"><a href="#"></a>Nous contacter</a></button>
     </section>
     <section class="recup u-margin-top-big container-big">
          ...
          <div class="recup__button-right">
               <button class="btn btn__dark u-margin-top-small u-margin-bottom-big"><a href="#"></a>Nous contacter</a></button>
          </div>
     </section>
